...
import { Forgetpassword } from "../../reduximplement/actions/UserAction";
import { clearErrors } from "../../reduximplement/actions/UserAction";
import { useDispatch, useSelector } from "react-redux";
import { useAlert } from "react-alert";
import MetaData from "../MetaData";
import styled from "styled-components";
import { resetMessage } from "../../reduximplement/actions/UserAction";
...
const ForgetPassword = () => {
    ...
    const{loding,error,message}=useSelector((state)=>state.forgetuser);
